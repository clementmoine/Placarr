...
| ~~**P3**~~ | ~~Local full-set / dump sync~~ | **First cut 2026-07-24** — iCollect + LaunchBox. **No-Intro Tier0 + multi-DAT + checksum-first + DAT pack sync 2026-07-24**. Reste : file-ingest UI. |
