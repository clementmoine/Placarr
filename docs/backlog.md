...
| **P2** | Scrape-yield / call efficiency | **… + Booknode/Smartoys SearchYield durable 2026-07-24**. Reste : corpora ; Chasse SearchYield. Voir [scrape_yield.md](scrape_yield.md). |
