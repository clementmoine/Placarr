...
| **P2** | Scrape-yield / call efficiency | **… + AMC/BM SearchYield durable 2026-07-24**. Reste : corpora ; autres peers promote SearchYield. Voir [scrape_yield.md](scrape_yield.md). |
