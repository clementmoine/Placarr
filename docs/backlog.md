...
| ~~**P3**~~ | ~~Local full-set / dump sync~~ | **First cut 2026-07-24** — iCollect + LaunchBox. **DAT parser 2026-07-24** ; **SQLite index 2026-07-24** (`pnpm nointro:build-index`). Reste : Tier0 module / multi-DAT / Redump. |
| ~~**P3**~~ | ~~LaunchBox / dumps~~ | **LB prebuild 2026-07-24** ; **No-Intro parse+index 2026-07-24**. Reste : Tier0 wiring ; mesure FTS (P4). |
