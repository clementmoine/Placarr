...
| **P2** | Scrape-yield / call efficiency | **… + Presta SearchYield + Smartoys 1→1 2026-07-24**: eBay Browse reuse ; Presta barcode enrich SearchYield-first ; Smartoys search→rank→1 detail. Reste : peers (AMC…), corpora, SearchYield durable. Voir [scrape_yield.md](scrape_yield.md). |
