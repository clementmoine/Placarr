...
| **P2** | Scrape-yield / call efficiency | **PC + gate + evidence + boardgame DetailYield 2026-07-24**: FetchStore/soft-404 ; abort ; scrape gate ; `ProviderEvidence` ; Philibert/Okkazeo/Esprit/Play-In keep `productUrl`+scan `sourceUrl`. Reste : factories Presta/Shopify, eBay batch, corpora. Voir [scrape_yield.md](scrape_yield.md). |
