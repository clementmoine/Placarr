...
| **P2** | Word-lists → consensus / IDF | **First cut 2026-07-24**: DRY stoplists → `IDENTITY_*` ; IDF MVP `tokenCorpusIdf` + optional stats on evidence specificity. Reste : index RawName offline / cron, élargir call sites. Inventaire [word_list_audit.md](word_list_audit.md). |
