...
| ~~**P3**~~ | ~~Local full-set / dump sync~~ | **First cut 2026-07-24** — iCollect + LaunchBox. **DAT parser 2026-07-24** (`nointro/parseDat`). Reste : index SQLite + Tier0 / Redump. |
| ~~**P3**~~ | ~~LaunchBox / dumps~~ | **LB prebuild 2026-07-24** ; **No-Intro parse 2026-07-24**. Reste : dump index ; mesure FTS (P4). |
