...
| **P2** | Scrape-yield / call efficiency | **… + Chasse + Booknode SearchYield→1 2026-07-24**. Reste : Back Market cache, corpora, SearchYield durable. Voir [scrape_yield.md](scrape_yield.md). |
