...
| **P2** | Scrape-yield / call efficiency | **… + AMC cache + Chasse SearchYield→1 fiche 2026-07-24**. Reste : Booknode/Back Market, corpora, SearchYield durable. Voir [scrape_yield.md](scrape_yield.md). |
