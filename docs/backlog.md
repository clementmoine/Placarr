...
| **P2** | Scrape-yield / call efficiency | **… + Back Market cache + Geedie search-first 2026-07-24**. Reste : corpora, SearchYield durable (search-aware URL keys). Voir [scrape_yield.md](scrape_yield.md). |
