...
| **P3**     | React Compiler rules sweep           | **Ouvert**          | 35 warnings `react-hooks` (set-state-in-effect ×13, exhaustive-deps ×7, static-components ×6, preserve-manual-memoization ×6, incompatible-library ×2, purity ×1) ; refontes composant par composant (admin, item detail, modals, carousel) avec vérification UI.                                                                                                                                                                                                                                              |
