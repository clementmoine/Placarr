...
| **P2** | Scrape-yield / call efficiency | **… + Smartoys 1→1 + AMC SearchYield/fiche cache 2026-07-24**. Reste : peers (Geedie…), corpora, SearchYield durable. Voir [scrape_yield.md](scrape_yield.md). |
