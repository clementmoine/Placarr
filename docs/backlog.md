...
| **P2** | Word-lists → consensus / IDF | **First cut 2026-07-24**: DRY → `IDENTITY_*` ; IDF MVP + in-memory cluster stats. **Offline RawName DF index 2026-07-24** (`pnpm title-idf:build-index`). Reste : cron schedule / shrink `GENERIC_TITLE_TOKENS`. |
