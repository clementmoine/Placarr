...
| **P2** | Scrape-yield / call efficiency | **… + Geedie search-first + SearchYield durable (PC) 2026-07-24**. Reste : corpora ; peers promote SearchYield. Voir [scrape_yield.md](scrape_yield.md). |
