...
| **P2** | Scrape-yield / call efficiency | **… + Booknode + Back Market HTML cache 2026-07-24**. Reste : corpora, SearchYield durable, Geedie soft edges. Voir [scrape_yield.md](scrape_yield.md). |
