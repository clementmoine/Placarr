# E-mail à envoyer à suggestions@lorcanajson.org

**Objet :** Suggestion: expose hot foil colour and second varnish mask from the catalog
...
In the current French catalog this affects 83 variants for the colour (9 distinct
values) and 2 for the second layer — so it is a small addition, but without it
those cards can't be rendered correctly at all.
