...
| Dragon Ball Carddass / JCC         | `dbsjcc` → `data/dragonball/jcc/` (dbzcollection + carddass.fr/dbz + nikita DBC) | ja partiel + FR      | FR + JA (nikita)                     | —                                     | ❌                                | Original JA (D-) ; FR adaptation — printKey `dbsjcc:…`                                               |
| Dragon Ball Heroes                 | `dbh` → `data/dragonball/heroes/` (carddass.com/dbh)                           | JA officiel           | JA thumbnails                        | —                                     | ❌                                | Cardlist live Bandai — pas de trad EN inventée                                                        |
