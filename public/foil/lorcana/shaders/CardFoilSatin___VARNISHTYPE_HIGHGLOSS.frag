...
void main()
{
    ...
    u_xlat11 = u_xlat16_1 * abs(u_xlat26);
    u_xlat26 = -abs(u_xlat26) * u_xlat16_1 + 1.0;
    u_xlat5.xyz = u_xlat16_2.xyz * vec3(u_xlat11);
    u_xlat28 = dot(u_xlat5.xyz, vec3(0.212672904, 0.715152204, 0.0721750036));
    u_xlat5.xyz = vec3(u_xlat11) * u_xlat16_2.xyz + (-vec3(u_xlat28));
    u_xlat5.xyz = u_xlat5.xyz * vec3(0.75, 0.75, 0.75) + vec3(u_xlat28);
    ...
    u_xlat15.xyz = u_xlat6.xyz * u_xlat6.xyz;
    u_xlat6.xyz = u_xlat6.xyz * u_xlat15.xyz;
    u_xlat10.xyz = u_xlat6.xyz * abs(u_xlat10.xxx) + u_xlat5.xyz;
    u_xlat3.x = u_xlat16_7.x * _FoilDisplacementStrength + u_xlat3.x;
    ...
    u_xlat19.x = _DeviceRotationDegrees * 0.0174532924;
    u_xlat5.x = sin(u_xlat19.x);
