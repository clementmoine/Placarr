...
void main()
{
    u_xlat0.xy = vs_INTERP0.xy * _FoilDisplacementTiling.xy;
    u_xlat16_0.xyz = texture(_SampleTexture2D_f44e690f3f3541a884ac95936014fc30_Texture_1_Texture2D, u_xlat0.xy).xyz;
    u_xlat1.y = u_xlat16_0.x * _FoilDisplacementStrength;
    u_xlat1.x = _TimeFactor * _CosTime.w + u_xlat1.y;
    u_xlat1.xy = u_xlat1.xy + vec2(0.5, 0.300000012);
    u_xlat1.xy = u_xlat1.xy + (-vec2(_FoilDisplacementStrength));
    u_xlat15 = _DeviceRotationDegrees * 0.0174532924;
    u_xlat2.x = sin(u_xlat15);
    u_xlat3.x = cos(u_xlat15);
    u_xlat4.x = (-u_xlat2.x);
    u_xlat4.y = u_xlat3.x;
    u_xlat4.z = u_xlat2.x;
    u_xlat11.xy = vs_INTERP0.xy + vec2(-0.5, -0.5);
    u_xlat2.y = dot(u_xlat11.xy, u_xlat4.xy);
    u_xlat2.x = dot(u_xlat11.xy, u_xlat4.yz);
    u_xlat2.xy = u_xlat2.xy + vec2(0.5, 0.5);
    u_xlat1.xy = u_xlat2.xy * vec2(0.5, 1.0) + u_xlat1.xy;
    u_xlat16_2.xyz = texture(_RainbowGradientTex, u_xlat1.xy).xyz;
    u_xlat15 = _DeviceRotationDegrees + 70.0;
    ...
    u_xlat4.y = u_xlat3.x;
    u_xlat4.z = u_xlat1.x;
    u_xlat1.x = dot(u_xlat11.xy, u_xlat4.yz);
    u_xlat1.y = dot(u_xlat11.xy, u_xlat4.xy);
    u_xlat1.xy = u_xlat1.xy + vec2(0.5, 0.5);
    u_xlat3.x = _CosTime.w * _TimeFactor;
    u_xlat3.y = 0.300000012;
    u_xlat1.xy = u_xlat1.xy * vec2(0.330000013, 0.330000013) + u_xlat3.xy;
    u_xlat16_1.xy = texture(_SampleTexture2D_ecaa018932e843b68c4797464457ac07_Texture_1_Texture2D, u_xlat1.xy).xy;
    u_xlat15 = (-u_xlat16_1.x) + 1.0;
    u_xlat2.xyz = u_xlat16_2.xyz * abs(vec3(u_xlat15));
    u_xlat3.xyz = u_xlat16_1.xxx * vec3(0.600000024, 0.548571527, 0.449999988);
    u_xlat0.xyz = u_xlat16_0.xyz * vec3(0.300000012, 0.274285764, 0.224999994) + u_xlat3.xyz;
    u_xlat3.xyz = u_xlat0.xyz * u_xlat0.xyz;
    u_xlat0.xyz = u_xlat0.xyz * u_xlat3.xyz;
    u_xlat16_3.xyz = texture(_Motif, vs_INTERP0.xy).xyz;
    u_xlat15 = dot(u_xlat16_3.xyz, vec3(0.212672904, 0.715152204, 0.0721750036));
    u_xlat15 = (-u_xlat15) + 1.0;
    u_xlat11.x = abs(u_xlat15) * u_xlat16_1.x;
    u_xlat15 = (-u_xlat16_1.x) * abs(u_xlat15) + 1.0;
    u_xlat1.xyw = u_xlat16_1.yyy * vec3(0.125000015, 0.140441179, 0.150000006);
    u_xlat4.xyz = u_xlat11.xxx * u_xlat16_3.xyz;
    u_xlat4.xyz = u_xlat4.xyz * vec3(1.32999992, 1.35294116, 1.37647057);
    u_xlat4.xyz = u_xlat16_3.xyz * vec3(0.469999999, 0.447058797, 0.423529387) + u_xlat4.xyz;
    u_xlat0.xyz = u_xlat0.xyz * abs(vec3(u_xlat15)) + u_xlat4.xyz;
    u_xlat0.xyz = u_xlat2.xyz * vec3(vec3(_RainbowStrength, _RainbowStrength, _RainbowStrength)) + u_xlat0.xyz;
    u_xlat16_2.xyz = texture(_MotifMask, vs_INTERP0.xy).xyz;
    u_xlat4.xyz = (-u_xlat16_2.xyz) + vec3(1.0, 1.0, 1.0);
    u_xlat3.xyz = u_xlat16_3.xyz * abs(u_xlat4.xyz);
    u_xlat0.xyz = u_xlat0.xyz * u_xlat16_2.xyz + u_xlat3.xyz;
    u_xlat16_2.xy = texture(_Texture2DAsset_450a32acbdb1461b842432479265bb3d_Out_0_Texture2D, vs_INTERP0.xy).xy;
    u_xlat0.xyz = u_xlat1.xyw * u_xlat16_2.xxx + u_xlat0.xyz;
