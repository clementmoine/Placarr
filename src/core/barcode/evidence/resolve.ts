...
import { getRepresentativeScore } from "@/core/title/displayScore";
import { VIDEO_GAME_PLATFORM_TOKEN_TERMS } from "@/core/games/platforms";
import { isBarcodeRecordSlimMode } from "@/core/barcode/lookup/recordMode";
import { confrontWithDatabase } from "@/core/metadata/database";
