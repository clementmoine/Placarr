/**
 * Observation-based projection ranking for the merge engine.
 */
...
export function orderResultsByObservationStrength(
  results: ProviderMetadataInput[],
...
export function pickBestMetadataObservationImageUrl(
  results: ProviderMetadataInput[],
): string | undefined {
...
export function pickBestMetadataObservationTitle(
  results: ProviderMetadataInput[],
): string | undefined {
