...
import { isBarcodeRecordSlimMode } from "@/core/identify/lookup/recordMode";
import {
...
import { NON_CANONICAL_CONTEXT_TOKENS } from "@/core/identify/listingTerms";
import { applyEditionToCompiledResult } from "./edition";
import type { CompiledResult, ProductEvidence, SourceProduct } from "./types";
import { BOOK_BARCODE_PREFIX, CONSENSUS, TYPE_SCORE } from "./scoring";
...
export async function compileResultForType(
  ...
  const databaseEvidence =
    hasAnchorSignals || isBarcodeRecordSlimMode() || process.env.RECORD
      ? []
...
export { NON_CANONICAL_CONTEXT_TOKENS } from "@/core/identify/listingTerms";
