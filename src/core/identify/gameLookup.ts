...
import {
  ...
  type PlatformSignal,
} from "@/core/identify/platformPick";
import {
...
import { createGameBarcodeEnrichmentDeps } from "@/core/catalog/barcode";

import type { GameBarcodeEnrichmentDeps } from "@/types/providerModule";

export const CLASSICS_KEYWORDS = GAME_CLASSICS_KEYWORDS;

export type { PlatformSignal } from "@/core/identify/platformPick";
export { pickPlatformKeyFromSignals } from "@/core/identify/platformPick";
