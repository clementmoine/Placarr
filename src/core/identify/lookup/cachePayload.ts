...
} from "@/core/identify/evidence/observations";
import { pickBarcodeFieldValuesFromObservations } from "@/core/identify/evidence/ranking";
import {
  formatDisplayNameWithEdition,
  inferEditionFromNames,
} from "@/core/identify/evidence/edition";
