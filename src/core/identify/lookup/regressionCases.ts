...
export const DEFAULT_BARCODE_REGRESSION_CASES: BarcodeRegressionCase[] = [
  ...
  },
  {
    ...
    label: "Tom Clancy's Ghost Recon (3307210117168 — pas le « 2 », pas album)",
  ...
  {
    id: "fantastic-mr-fox-book",
    label: "Fantastic Mr. Fox (ISBN)",
    barcode: "9780140328721",
    type: "books",
    expected: {
      cleanNameIncludes: ["Fantastic", "Fox"],
      shelfType: "books",
      maxMatches: 2,
    },
  },
  {
    id: "discovery-daft-punk-music",
    label: "Discovery — Daft Punk",
    barcode: "0724384960650",
    type: "musics",
    expected: {
      cleanNameIncludes: ["Discovery"],
      shelfType: "musics",
      maxMatches: 2,
    },
  },
  ...
  },
  {
    ...
    type: "boardgames",
    expected: {
      cleanNameIncludes: ["Catan"],
      shelfType: "boardgames",
      maxMatches: 2,
    },
  },
  {
    id: "inception-dvd-movie",
    label: "Inception (DVD)",
    barcode: "7321906123457",
    type: "movies",
    expected: {
      shelfType: "movies",
      maxMatches: 3,
