...
} from "@/core/media/coverProvenance";
import { isCoverEligibleAttachmentType } from "@/core/media/coverUrl";
import {
  MIN_COVER_SHORTEST_EDGE,
  isCoverResolutionAcceptable,
  shortestImageEdge,
} from "@/core/media/coverResolution";
import { exposureScoreAdjustment } from "@/core/media/coverExposure";
import {
...
export type ScoredAttachmentInput = {
   ...
   * same region. See `@/core/media/coverProvenance`.
   */
