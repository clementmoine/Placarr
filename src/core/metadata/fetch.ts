...
} from "@/core/metadata/selection";
import { resolveMetadataProvidersInOrder } from "@/core/metadata/providerQueue";
...
import { loadBarcodeAlternateNames } from "@/core/barcode/alternateNames";
...
import { isMetadataProviderQuotaBlocked } from "@/core/metadata/selection";
import {
  areDisplayTitlesSameProduct,
  requestedTitleCoversCurrentTitle,
} from "@/core/title/displayScore";
import { aliasesExcludingTitle } from "@/core/metadata/aliases";
import { withBookSearchAliases } from "@/core/metadata/bookSearchAliases";
import {
  mergeMetadata,
  preferRequestedDisplayTitle,
} from "@/core/metadata/merge";
import {
  dedupeFieldEvidence,
  dedupeFacts,
  metadataFieldEvidence,
} from "@/core/metadata/facts";
import {
  dedupeProviderExternalLinkFacts,
  externalLinkFactsFromFieldEvidence,
} from "@/core/metadata/providerExternalLinks";
import type { MetadataResult } from "@/types/metadataProvider";
import { buildBoardGameMetadataSearchQueries } from "@/core/metadata/boardGame";
import { buildBookMetadataSearchQueries } from "@/core/metadata/bookSearch";
import { buildPriceSearchQueries } from "@/core/pricing/searchQueries";
import { preferredMetadataLanguagesFromShelfName } from "@/core/metadata/shelfContentLocale";
...
import { metadataResultsNeedGalleryEnrichment } from "@/core/metadata/galleryEnrichment";
import {
...
} from "@/core/metadata/metadataFetchGating";
