...
import { refineCatalogDisplayTitle } from "@/core/title/refineCatalogDisplayTitle";
import {
  bundleTitlePartsMatchCatalogTitle,
  isBundleTitle,
} from "@/core/metadata/bundleTitle";
import {
  isMetadataTitleAligned,
  descriptionMatchesRequestedTitle,
} from "@/core/metadata/titleMatching";
import { buildEditionPhraseEquivalentVariants } from "@/core/title/searchVariants";
import {
...
} from "@/core/metadata/mergeObservationRanking";
import type { ProviderMetadataInput } from "@/core/metadata/mergeObservationRanking";

// Re-exported so `@/core/metadata/merge` keeps its previous public surface
// after the observation-ranking helpers moved to ./mergeObservationRanking.
export {
  pickBestMetadataFactsFromObservations,
  pickBestMetadataTitle,
} from "@/core/metadata/mergeObservationRanking";
export type { ProviderMetadataInput } from "@/core/metadata/mergeObservationRanking";
