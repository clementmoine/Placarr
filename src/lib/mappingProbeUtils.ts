...
const RAW_KEY_ALIASES: Record<string, string[]> = {
  ...
  image: ["imageUrl", "attachments", "cover"],
  ...
  statistics: ["facts", "rating", "popularity"],
  ...
  thumbnail: ["imageUrl", "attachments", "cover"],
  ...
  averageweight: ["complexity", "facts"],
  boardgameartist: ["artist", "authors", "people", "facts"],
  boardgamedesigner: ["authors", "people"],
  boardgamepublisher: ["publishers"],
  boardgamecategory: ["category", "genre", "facts"],
  boardgamemechanic: ["mechanic", "facts"],
  boardgamefamily: ["family", "facts"],
  "poll-summary": ["recommended-players", "facts"],
