...
import { narutoPrintFacts } from "./identity";
import {
  narutoAssetsCardUrl,
...
} from "@/providers/naruto/shared/gg/ggArchivePrices";
...
const narutocarddassCatalogHooks = cardCatalogueHooks({
  packId: DATA_PACK,
...
export const refreshNarutoCcgCatalog = narutocarddassCatalogHooks.refresh;
export const narutoCcgCatalogStatus = narutocarddassCatalogHooks.status;
const narutocarddassCatalog: ProviderCatalogHooks = narutocarddassCatalogHooks;
