...
import { kayouSetLabelFromLedger } from "./pipeline/ledgers";
import { stampKayouFoil } from "./finishes";
import { kayouLenticularCropProfileForPrintKey, kayouLenticularGridForPrintKey, kayouScanCropForPrintKey } from "./pipeline/lenticular";
import { stampKayouBack } from "./sources/backs";
import {
...
export const narutokayouModule = {
  ...
  refreshBarcodePriceOffers: async (
    ...
    const { refreshKayouGgPriceOffers } = await import("./sources/prices");
