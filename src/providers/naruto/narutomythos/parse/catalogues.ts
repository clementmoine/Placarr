/**
 * Mythos catalogue parsers — LorenZone SS2 gallery faces + CICABOOM official API.
 *
 * Merged from: parseLorenzoneSs2Faces, parseOfficialCards.
 */

// ─── LorenZone Shinobi Shiren (SS2) gallery faces ─────────────────────────
...
// ─── CICABOOM official gallery API ────────────────────────────────────────
// Merged from: parseOfficialCards.ts
