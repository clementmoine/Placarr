...
import { installReconstructedFaces, listCuratedReconstructedFaces } from "./reconstructedFaces";
...
// —— installReconstructedFaces ——
{
  ...
  /*
    ...
    `src/providers/naruto/narutoranks/curated/` écraserait un scan du catalogue.
  */
