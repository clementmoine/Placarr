...
export const NARUTO_PRODUCT_SOURCES = [
  ...
  "cardgameclub",
  "martina",
  /** Emporio di Milo pasted shop photos — Serie 5 IT mazzi. */
  "emporiodimilo",
  /** Vinted pasted CDN — sealed multi-angle shop photos (signed URLs only). */
  "vinted",
  /** Leboncoin pasted CDN — FR sealed packaging (art + verso text). */
  "leboncoin",
  /** Rakuten FR shopping — pasted product pictures (no crawl). */
  "rakuten",
  /** Kinkai pasted uploads — FR retail blister verso (EAN + pack math). */
  "kinkai",
  /** Sunny Store Shopify CDN — FR/ES/EN sealed packshots (pastes only). */
  "sunnystore",
  "gradedcardcenter",
  "coleka",
  "goat",
  "manga-news",
  /** manga-sanctuary.com presse 2008 — packshots S5 (starters + booster). */
  "manga-sanctuary",
  /**
   * Collector Drive « Bandai (FR/US) » — EN CCG sealed album (DOCX embeds).
   * Local staging only; never display-s1…s6.
   */
  "bandai-drive",
  "scifi-universe",
  "carddass",
  ...
  "tvtokyo",
  /** ToyWiz BigCommerce CDN pastes (EN CCG booster packs). */
  "toywiz",
  /** Atomic Empire Alliance CDN pastes (EN CCG display boxes). */
  "atomicempire",
  /**
...
> = {
  ...
  /** Castellano Carddass — seule source collée à ce jour : sunnystore.es. */
  es: [
    "badge",
    "sunnystore",
    "ebay",
...
const STAGING_FOLDER_SOURCE: Readonly<Record<string, NarutoProductSource>> = {
  ...
  "manga-sanctuary": "manga-sanctuary",
  "bandai-fr-us-drive": "bandai-drive",
  cardgameclub: "cardgameclub",
  martina: "martina",
  emporiodimilo: "emporiodimilo",
  vinted: "vinted",
  leboncoin: "leboncoin",
  rakuten: "rakuten",
  kinkai: "kinkai",
  sunnystore: "sunnystore",
  gradedcardcenter: "gradedcardcenter",
  "goat-en-boxes": "goat",
  "coleka-en-covers": "coleka",
  "coleka-s24": "coleka",
  "coleka-s28": "coleka",
  "coleka-rampage-tornado": "coleka",
  "scifi-universe": "scifi-universe",
  "tv-tokyo": "tvtokyo",
  toywiz: "toywiz",
  atomicempire: "atomicempire",
  mercari: "mercari",
