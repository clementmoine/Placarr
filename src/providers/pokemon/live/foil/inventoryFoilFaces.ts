 ...
 *
 * Usage:
 *   tsx src/providers/pokemon/live/foil/inventoryFoilFaces.ts
 *   tsx src/providers/pokemon/live/foil/inventoryFoilFaces.ts -- --effect SunPillar
 */
...
function main(): void {
  ...
  console.log(
    `# Foil face inventory (dump + owned preference)\n` +
      ...
      `# Note: TCG Live collection is server-side — sync via tsx src/providers/pokemon/live/pipeline/syncLiveOwned.ts\n` +
