...
import { parsePokemonBundleStem } from "@/providers/pokemon/live/cdn/malieCardLayers";

import simeyFoils from "@/providers/pokemon/live/curated/sources/simey-poke-holo-foils.json";
