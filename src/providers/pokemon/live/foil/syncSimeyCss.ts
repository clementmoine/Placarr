 ...
 *
 *   tsx src/providers/pokemon/live/foil/syncSimeyCss.ts
 *   tsx src/providers/pokemon/live/foil/syncSimeyCss.ts -- --check
 *   tsx src/providers/pokemon/live/foil/syncSimeyCss.ts -- --force
 */
import {
  copyFileSync,
  cpSync,
