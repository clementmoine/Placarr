...
import { resolvePokemonArtFilename } from "@/providers/pokemon/tcgdex/disk/faceChoice";
import {
  loadTcgdexNameLookup,
  resolveTcgdexIndexName,
} from "@/providers/pokemon/tcgdex/lookupTitle";
import {
...
export function rebuildPokemonCardsIndex(opts?: {
  ...
  const orphanTitles = loadLiveOrphanTitles();
  attachTitlesToCardsIndex(index, (printKey) =>
    resolveLiveOrphanIndexName(printKey, orphanTitles),
  );
