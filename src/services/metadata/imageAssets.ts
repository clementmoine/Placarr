...
import { type AttachmentImageMetrics } from "@/lib/media/attachmentDisplayScore";
import { isCoverResolutionAcceptable } from "@/lib/media/imageMetrics";
...
import { isPlaceholderCoverImage } from "@/lib/media/coverPlaceholder";
